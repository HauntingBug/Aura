...
import Island from "../../../model/island.js";
...
export async function execute(interaction) {
    ...
    if (!followsRegex)
        return interaction.editReply("Invalid island code format. Use `0000-0000-0000`");
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields({ name: "Title", value: interaction.options.getString("title"), inline: true }, { name: "Description", value: interaction.options.getString("description"), inline: true }, { name: "Mnemonic", value: interaction.options.getString("mnemonic"), inline: true });
