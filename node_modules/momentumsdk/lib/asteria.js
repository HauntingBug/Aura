...
class Asteria {
    ...
    getEntity(key, value, entity, ignoreErrors) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(`Fetching ${this.usedURL}${entity}/ for ${key} and ${value}...`);
    ...
    getCosmetic(key, value, ignoreErrors) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(`Fetching cosmetics for ${key} and ${value}...`);
    ...
    getBanner(key, value, ignoreErrors) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(`Fetching banners for ${key} and ${value}...`);
                if (ignoreErrors !== undefined)
    ...
    getPlaylist(key, value, ignoreErrors) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(`Fetching playlists for ${key} and ${value}...`);
                if (ignoreErrors !== undefined)
    ...
    getPoi(key, value, ignoreErrors) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(`Fetching POIs for ${key} and ${value}...`);
                if (ignoreErrors !== undefined)
